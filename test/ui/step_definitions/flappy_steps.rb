...
Then /^I see the first Flappy YouTube video with the correct parameters$/ do
  correct_video_url = 'https://www.youtubeeducation.com/embed/VQ4lo6Huylc/?autoplay=1&iv_load_policy=3&modestbranding=1&rel=0&showinfo=1&v=VQ4lo6Huylc&wmode=transparent'
